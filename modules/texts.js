...
exports.providerJumio = () => {
	return "After payment, you will be redirected to Jumio website for your document (ID, driver's licence, passport) verification. Your device must have a high quality camera to make photos of your face and your document. Have your document ready before payment and make sure there is enough light in your room, the document must have your name printed in Latin characters. If Jumio fails to read your document then you lose your payment and have to pay again for another try.";
}

exports.providerSmartID = () => {
	return "After payment, you will be redirected to Smart ID Estonia website for authentication. You need to authenticate with ID-card, Mobile-ID or Smart-ID (available for residents of Estonia, Latvia, Lithuania or e-residents of Estonia). If you fail to authenticate then you lose your payment.";
}
